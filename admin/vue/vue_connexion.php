...
<head>
    <meta charset="utf-8">
    <title>Homeniscience Admin Board</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!-- <link rel="stylesheet" type="text/css" media="screen and (max-width: 800px)" href="css/mobile.css" /> -->
    <link rel="stylesheet" type="text/css" media="screen and (min-device-width: 801px)" href="/homeniscience/support/vue/style_connexion.css"/>
</head>
<body>
