    ...
    <div class="container1">
        <div class="flex1"  >
            ...
            <div class="panel" >
                ...
                <P style="padding-left: 100px;padding-right: 100px"> Vous n'etes pas utilisateur principal de votre domicile, vous ne pouvez donc pas acceder cette page!!!!! <br> Vous pouvez contacter votre utilisateur principal si vous voulez en devenir un. <br><br> Cliquez sur "OK" pour revenir à l'accueil <b>;-)</b></P>
