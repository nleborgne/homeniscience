...
<head>
  ...
  <script type="text/javascript" src="https://raw.githubusercontent.com/vdw/HideSeek/master/jquery.hideseek.min.js"></script>
  <meta charset="utf-8">
...
<body>
  ...
  <div class="container">
    <input class="search" id="search" name="search" placeholder="Start typing here" type="text" data-list=".list">
    <div class="flex2">
  ...
  /*
  old header, not used anymore (confirm in 2.1 ?)
